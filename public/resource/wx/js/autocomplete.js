...
AutoComplete.prototype = {
    ...
    */
    draw: function (matchedString, maxMatchedItemNumberAllowed) {
        ...
        // } else {
            ...
            //} else {
                div.style.top =52+scrollTop +top + height + "px";
           // }
        // }
    ...
    */
    evaluate: function (trSrc) {
        this.inputElement.value =eval("trSrc.item." + this.params.textName);//eval("trSrc.item." + this.params.textField)+"-"+ eval("trSrc.item." + this.params.textName);
        this.inputElement.focus();
    },
    ...
    match: function (matchedString, maxMatchedItemNumberAllowed) {
        ...
        for (var i = 0; i < this.dataSource.length; i++) {
            for (var j = 0; j < this.params.matchFields.length; j++) {
                if (this.dataSource[i][this.params.matchFields[j]] && this.dataSource[i][this.params.matchFields[j]].toUpperCase().indexOf(matchedString.toUpperCase(), 0) != -1) {
