const backgroundCanvas = (el) => {
  Object.assign(el, {
    width: window.innerWidth,
    height: window.innerHeight,
  });
  el.style.cssText = 'position: fixed; width: 100%; height: 100%; z-index: -100; left: 0; top: 0';
  ...
  function ColorPoint(x, y, color) {
    ...
    this.color = function () {
      return new Color(this.newColor.h, this.newColor.s, this.newColor.l);
    };
  }
  const colorPoints = [
    new ColorPoint(0, 0, new Color(38, 100, 75)),
    new ColorPoint(0, 1, new Color(42, 98, 79)),
    new ColorPoint(1, 0, new Color(36, 96, 74)),
    new ColorPoint(1, 1, new Color(41, 97, 78)),
  ];
  ...
  function render() {
    ...
    colorPoints.forEach((point, index) => {
      ...
      grad.addColorStop(0, colors[index][0]);
      grad.addColorStop(1, colors[index][1]);
